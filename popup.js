...
const colorSec = document.querySelector('.color-section')
...
document.querySelector('#playBTN').addEventListener('click',()=>{
    ...
    document.querySelector('#colorSectionBTN').classList.remove('okActive');
...
document.querySelector('#colorSectionBTN').addEventListener('click', () => {
    playground.classList.add('hidden');
    home.classList.add('hidden');
    recent50.classList.add('hidden');
    document.querySelector('#playBTN').classList.remove('okActive');
    document.querySelector('#homeBTN').classList.remove('okActive');
    document.querySelector('#recent50BTN').classList.remove('okActive');
    document.querySelector('#colorSectionBTN').classList.add('okActive');
    document.querySelector('#headerName').innerText = 'All Colors Used';
  });
...
deleteAllBtn.addEventListener('click', function() {
    if (confirm("Are you sure you want to delete all saved colors?")) {
        ...
        colorArr = [];
        render(); // Render the UI again after deletion
        show_toast("All saved colors deleted");
    }
});
...
// playground dropdown
playCheckbox.forEach((element,i)=>{
...
//     const colorSectionBtn = document.getElementById('colorSectionBTN');
//     const colorSection = document.querySelector('.color-section');
  
//     // Function to extract colors from CSS stylesheet
...
//               colors.add(color);
//             }
//             if (backgroundColor && backgroundColor !== 'inherit' && backgroundColor !== 'initial') {
...
//     // Function to create color grid elements
...
//     colorSectionBtn.addEventListener('click', function() {
//       colorSection.classList.toggle('hidden');
//       if (!colorSection.classList.contains('hidden')) {
//         const colors = extractColorsFromCSS();
//         colorGrid.innerHTML = ''; // Clear existing color grid
...
const colorGrid2 = document.querySelector('.color-grid');
const colorSectionBtn = document.getElementById('colorSectionBTN');
const colorSection = document.querySelector('.color-section');
...
function displayColors(colors) {
    ...
    colorSectionBtn.addEventListener('click', function() {
        ...
        if (!colorSection.classList.contains('hidden')) {
        //   const colors = extractColorsFromCSS();
          colorGrid2.innerHTML = ''; // Clear existing color grid
          createColorGrid(colors);
        }
    });
